...
public class MemberCourseService {
    ...
    public MemberCourseDto enroll(MemberCourseDto memberCourseDto) {
        ...
        if (memberCourseDb == null) {
            ...
            this.insert(memberCourse);
            // 将数据库信息全部返回，包括id, at
            MemberCourseDto memberCourseDto1 = new MemberCourseDto();
            BeanUtils.copyProperties(memberCourse, memberCourseDto1);
            return memberCourseDto1;
        } else {
            // 如果已经报名，则直接返回已报名的信息
            MemberCourseDto memberCourseDto1 = new MemberCourseDto();
            BeanUtils.copyProperties(memberCourseDb, memberCourseDto1);
            return memberCourseDto1;
        }
    }
