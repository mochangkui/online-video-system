  ...
  export default {
    ...
    methods: {
      ...
      init() {
        ...
        Loading.show();
        this.$ajax.get(process.env.VUE_APP_SERVER + '/business/admin/course/find-content/' + id).then((response)=>{
          Loading.hide();
      ...
      saveContent () {
        ...
        this.$ajax.post(process.env.VUE_APP_SERVER + '/business/admin/course/save-content', {
          id: this.course.id,
          content: content
        }).then((response)=>{
          Loading.hide();
       ...
       */
      listContentFiles() {
        this.$ajax.get(process.env.VUE_APP_SERVER + '/business/admin/course-content-file/list/' + this.course.id).then((response)=>{
          let resp = response.data;
          if (resp.success) {
      ...
      afterUploadContentFile(response) {
        ...
        file.url = file.path;
        this.$ajax.post(process.env.VUE_APP_SERVER + '/business/admin/course-content-file/save', file).then((response)=>{
          let resp = response.data;
          if (resp.success) {
