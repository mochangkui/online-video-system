...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        Loading.show();
        this.$ajax.post(process.env.VUE_APP_SERVER + '/business/admin/section/list', {
          page: page,
      ...
      save(page) {
        ...
        Loading.show();
        this.$ajax.post(process.env.VUE_APP_SERVER + '/business/admin/section/save', this.section).then((response)=>{
          Loading.hide();
          let resp = response.data;
          if (resp.success) {
