        ...
        return function(t) {
            ...
            1: function(t, e, o) {
                ...
                class s {
                    ...
                    render(t) {
                        ...
                        this.options && this.options.data && n.a.each(this.options.data, (t,o)=>{
                                e.attr("data-" + t, o)
                            }
                        ),
                ...
                e.a = {
                    create: (t,e)=>function() {
                        ...
                        return o && o.children && (i = o.children),
                            new s(t,i,o,e)
                    }
                }
            },
            ...
            3: function(t, e, o) {
                ...
                var y = {
                    ...
                    clusterBy: function(t, e) {
                        return t.length ? C(t).reduce((function(t, o) {
                                const i = k(t);
                                return e(k(i), o) ? i[i.length] = o : t[t.length] = [o],
                                    t
                            }
                        ), [[v(t)]]) : []
                    },
                ...
                function G(t, e) {
                    ...
                    let i = e.parentNode;
                    return o ? i.insertBefore(t, o) : i.appendChild(t),
                        t
                }
                function Z(t, e) {
                ...
                function it(t, e) {
                    ...
                    if (0 === t.offset) {
                        ...
                        ot(t.node) ? (o = t.node.childNodes[t.offset - 1],
                            i = j(o)) : (o = t.node,
                            i = e ? 0 : t.offset - 1);
                    return {
                        node: o,
                ...
                function nt(t, e) {
                    ...
                    if (j(t.node) === t.offset) {
                        ...
                        if (o = t.node.childNodes[t.offset],
                            i = 0,
                            W(o))
                            return null
                    } else if (o = t.node,
                        i = e ? j(t.node) : t.offset + 1,
                        W(o))
                        return null;
                    return {
                        node: o,
                ...
                var ut = {
                    ...
                    isVisiblePoint: function(t) {
                        if (I(t.node) || !ot(t.node) || W(t.node))
                            return !0;
                ...
                class pt {
                    ...
                    removeModule(t) {
                        const e = this.modules[t];
                        e.shouldInitialize() && (e.events && ut.detachEvents(this.$note, e.events),
                        e.destroy && e.destroy()),
                    ...
                    if (0 !== o && ut.isText(r[o - 1])) {
                        ...
                        for (; l > r.nodeValue.length && r.nextSibling; )
                            l -= r.nodeValue.length,
                                r = r.nextSibling;
                        r.nodeValue;
                        e && r.nextSibling && ut.isText(r.nextSibling) && l === r.nodeValue.length && (l -= r.nodeValue.length,
                            r = r.nextSibling),
                            i = r,
                            o = l
                    }
                ...
                function ft(t) {
                    const e = function(t, o) {
                        ...
                        , i = e(t.node, t.offset);
                    return o.moveToElementText(i.node),
                ...
                n.a.fn.extend({
                    summernote: function() {
                        ...
                        if (s.length) {
                            ...
                            if (e)
                                return t.invoke.apply(t, y.from(arguments));
                ...
                class gt {
                    ...
                    nativeRange() {
                        ...
                        }
                        {
                            ...
                            return t.setEndPoint("EndToEnd", ft({
                                node: this.ec,
                                offset: this.eo
                            })),
                                t
                    ...
                    normalize() {
                        const t = function(t, e) {
                            if (!t)
                                return t;
                            if (ut.isVisiblePoint(t) && (!ut.isEdgePoint(t) || ut.isRightEdgePoint(t) && !e || ut.isLeftEdgePoint(t) && e || ut.isRightEdgePoint(t) && e && ut.isVoid(t.node.nextSibling) || ut.isLeftEdgePoint(t) && !e && ut.isVoid(t.node.previousSibling) || ut.isBlock(t.node) && ut.isEmpty(t.node)))
                                return t;
                            const o = ut.ancestor(t.node, ut.isBlock);
                            let i = !1;
                            if (!i) {
                                const n = ut.prevPoint(t) || {
                                    node: null
                                };
                    ...
                    nodes(t, e) {
                        ...
                        return ut.walkPoint(n, s, (function(e) {
                                if (ut.isEditable(e.node))
                                    return;
                                let n;
                                i ? (ut.isLeftEdgePoint(e) && a.push(e.node),
                                ut.isRightEdgePoint(e) && y.contains(a, e.node) && (n = e.node)) : n = o ? ut.ancestor(e.node, t) : e.node,
                                n && t(n) && r.push(n)
                            }
                        ), !0),
                            y.unique(r)
                    ...
                    splitText() {
                        const t = this.sc === this.ec
                            , e = this.getPoints();
                        return ut.isText(this.ec) && !ut.isEdgePoint(this.getEndPoint()) && this.ec.splitText(this.eo),
                        ut.isText(this.sc) && !ut.isEdgePoint(this.getStartPoint()) && (e.sc = this.sc.splitText(this.so),
                            e.so = 0,
                        t && (e.ec = e.sc,
                    ...
                    isLeftEdgeOf(t) {
                        if (!ut.isLeftEdgePoint(this.getStartPoint()))
                            return !1;
                        const e = ut.ancestor(this.sc, t);
                    ...
                    wrapBodyInlineWithPara() {
                        if (ut.isBodyContainer(this.sc) && ut.isEmpty(this.sc))
                            return this.sc.innerHTML = ut.emptyPara,
                        ...
                        if (ut.isInline(t.sc)) {
                            ...
                            e = y.last(o),
                            ut.isInline(e) || (e = o[o.length - 2] || t.sc.childNodes[t.so])
                        } else
                            e = t.sc.childNodes[t.so > 0 ? t.so - 1 : 0];
                        if (e) {
                            let t = ut.listPrev(e, ut.isParaInline).reverse();
                            if (t = t.concat(ut.listNext(e.nextSibling, ut.isParaInline)),
                                t.length) {
                    ...
                    getWordsRange(t) {
                        ...
                        return t && (e = ut.nextPointUntil(e, o)),
                ...
                var bt = {
                    create: function(t, e, o, i) {
                            ...
                            return new gt(t,e,o = t,i = e);
                        {
                            ...
                            if (!t && 1 === arguments.length) {
                                let t = arguments[0];
                                return ut.isEditable(t) && (t = t.lastChild),
                    ...
                    createFromSelection: function() {
                        ...
                        if (f.isW3CRangeSupport) {
                            ...
                            let a = mt(r, !0)
                                , l = mt(s, !1);
                            ut.isText(a.node) && ut.isLeftEdgePoint(a) && ut.isTextNode(l.node) && ut.isRightEdgePoint(l) && l.node.nextSibling === a.node && (a = l),
                                t = a.cont,
                                e = a.offset,
                                o = l.cont,
                                i = l.offset
                    ...
                    createFromNode: function(t) {
                        let e = t
                            ...
                            , i = t
                            , n = ut.nodeLength(i);
                        return ut.isVoid(e) && (o = ut.listPrev(e).length - 1,
                            e = e.parentNode),
                            ut.isBR(i) ? (n = ut.listPrev(i).length - 1,
                                i = i.parentNode) : ut.isVoid(i) && (n = ut.listPrev(i).length,
                                i = i.parentNode),
                            this.create(e, o, i, n)
                    },
                ...
                class wt {
                    ...
                    fromNode(t) {
                        ...
                        return e["font-size"] = parseInt(o, 10),
                    ...
                    styleNodes(t, e) {
                        ...
                        if (t.isCollapsed())
                            return [t.insertNode(ut.create(o))];
                        let r = ut.makePredByNodeName(o);
                        const a = t.nodes(ut.isText, {
                            fullyContains: !0
                        }).map(t=>ut.singleChildAncestor(t, r) || ut.wrap(t, o));
                        if (i) {
                            if (s) {
                                const e = t.nodes();
                    ...
                    current(t) {
                        ...
                        return o.anchor = t.isOnAnchor() && ut.ancestor(t.sc, ut.isAnchor),
                ...
                class yt {
                    ...
                    indent(t) {
                        ...
                        n.a.each(i, (t,e)=>{
                                ...
                                if (ut.isLi(o)) {
                                    ...
                                    t ? e.map(e=>t.appendChild(e)) : (this.wrapList(e, o.parentNode.nodeName),
                                        e.map(t=>t.parentNode).map(t=>this.appendToPrevious(t)))
                                } else
                                    n.a.each(e, (t,e)=>{
                    ...
                    wrapList(t, e) {
                        ...
                        return t = t.map(t=>ut.isPurePara(t) ? ut.replace(t, "LI") : t),
                            ut.appendChildNodes(r, t),
                        s && (ut.appendChildNodes(r, y.from(s.childNodes)),
                            ut.remove(s)),
                            t
                    }
                    releaseList(t, e) {
                        ...
                        return n.a.each(t, (t,i)=>{
                                ...
                                if ("LI" === a.parentNode.nodeName)
                                    i.map(t=>{
                                            ...
                                            e.length && (this.wrapList(e, a.nodeName),
                ...
                class xt {
                    ...
                    insertParagraph(t, e) {
                        ...
                        if (o) {
                            ...
                            {
                                let t = null;
                                if (1 === this.options.blockquoteBreakingLevel ? t = ut.ancestor(o, ut.isBlockquote) : 2 === this.options.blockquoteBreakingLevel && (t = ut.lastAncestor(o, ut.isBlockquote)),
                                    t) {
                                    i = n()(ut.emptyPara)[0],
                ...
                const St = function(t, e, o, i) {
                    ...
                    this.getActionList = function() {
                        ...
                        ,
                        t && t.tagName && ("td" === t.tagName.toLowerCase() || "th" === t.tagName.toLowerCase()) ? (n.colPos = t.cellIndex,
                            t.parentElement && t.parentElement.tagName && "tr" === t.parentElement.tagName.toLowerCase() ? n.rowPos = t.parentElement.rowIndex : console.error("Impossible to identify start Row point.", t)) : console.error("Impossible to identify start Cell point.", t),
                        function() {
                            const t = i.rows;
                ...
                class $t {
                        ...
                        for (let t = 0; t < a.length; t++) {
                            ...
                            switch (o.action) {
                                ...
                                case St.resultAction.SumSpanCount:
                                    ...
                                    t++,
                                        o.baseCell.setAttribute("rowSpan", t)
                            }
                        }
                        if ("top" === e)
                            i.before(r);
                            ...
                            switch (o.action) {
                                ...
                                case St.resultAction.SumSpanCount:
                                    if ("right" === e) {
                                        ...
                                        t++,
                                            o.baseCell.setAttribute("colSpan", t)
                                    } else
                            ...
                            switch (r[t].action) {
                                ...
                                case St.resultAction.AddCell:
                                    ...
                                    a && (l > 2 ? (l--,
                                        ...
                                        t.cells[i].innerHTML = "") : 2 === l && (t.insertBefore(r, t.cells[i]),
                                ...
                                case St.resultAction.SubtractSpanCount:
                                    ...
                                    n.rowIndex !== s && e.cellIndex === i && (e.innerHTML = "")) : 2 === l && (e.removeAttribute("rowSpan"),
                                    n.rowIndex !== s && e.cellIndex === i && (e.innerHTML = "")));
                                    continue;
                                ...
                                switch (s[t].action) {
                                    ...
                                    case St.resultAction.SubtractSpanCount:
                                        ...
                                        if (e.colSpan && e.colSpan > 1) {
                                            ...
                                            e.cellIndex === i && (e.innerHTML = "")) : 2 === t && (e.removeAttribute("colSpan"),
                    ...
                    createTable(t, e, o) {
                        ...
                        return o && o.tableClassName && l.addClass(o.tableClassName),
                            l[0]
                    }
                    deleteTable(t) {
                        const e = ut.ancestor(t.commonAncestor(), ut.isCell);
                    ...
                    options: {
                        ...
                        modules: {
                            editor: class {
                                constructor(t) {
                                    ...
                                    this.insertParagraph = this.wrapCommand(()=>{
                                        ...
                                        this.insertNode = this.wrapCommand(t=>{
                                                if (this.isLimited(n()(t).text().length))
                                                    return;
                                                this.getLastRange().insertNode(t),
                                                    this.setLastRange(bt.createFromNodeAfter(t).select())
                                            }
                                        ),
                                        this.insertText = this.wrapCommand(t=>{
                                                if (this.isLimited(t.length))
                                                    return;
                                        ...
                                        this.createLink = this.wrapCommand(t=>{
                                                ...
                                                if (a > 0 && this.isLimited(a))
                                                    return;
                                                const l = r.toString() !== o;
                                                "string" == typeof e && (e = e.trim()),
                                                    this.options.onCreateLink ? e = this.options.onCreateLink(e) : s && (e = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(e) ? e : this.options.defaultProtocol + e);
                                                let c = [];
                                                if (l) {
                                                    r = r.deleteContents();
                                                ...
                                                n.a.each(c, (t,o)=>{
                                                        n()(o).attr("href", e),
                                                            i ? n()(o).attr("target", "_blank") : n()(o).removeAttr("target")
                                                    }
                                                );
                                        ...
                                        this.removeMedia = this.wrapCommand(()=>{
                                                ...
                                                t.closest("figure").length ? t.closest("figure").remove() : t = n()(this.restoreTarget()).detach(),
                                ...
                                initialize() {
                                    this.$editable.on("keydown", t=>{
                                            if (t.keyCode === kt.code.ENTER && this.context.triggerEvent("enter", t),
                                                this.context.triggerEvent("keydown", t),
                                                this.snapshot = this.history.makeSnapshot(),
                                            t.isDefaultPrevented() || (this.options.shortcuts ? this.handleKeyMap(t) : this.preventDefaultEditableShortCuts(t)),
                                                this.isLimited(1, t)) {
                                            ...
                                            this.setLastRange(),
                                                this.context.triggerEvent("keyup", t)
                                        }
                                    ).on("focus", t=>{
                                            this.setLastRange(),
                                                this.context.triggerEvent("focus", t)
                                        }
                                    ).on("blur", t=>{
                                            ...
                                            this.setLastRange(),
                                                this.context.triggerEvent("paste", t)
                                        }
                                    ).on("input", t=>{
                                    ...
                                    this.options.disableGrammar && this.$editable.attr("data-gramm", !1),
                                        ...
                                        this.$editable.on(f.inputEventName, b.debounce(()=>{
                                                this.context.triggerEvent("change", this.$editable.html(), this.$editable)
                                            }
                                            , 10)),
                                        this.$editor.on("focusin", t=>{
                                ...
                                isLimited(t, e) {
                                    return t = t || 0,
                                    (void 0 === e || !(kt.isMove(e.keyCode) || kt.isNavigation(e.keyCode) || e.ctrlKey || e.metaKey || y.contains([kt.code.BACKSPACE, kt.code.DELETE], e.keyCode))) && (this.options.maxTextLength > 0 && this.$editable.text().length + t > this.options.maxTextLength)
                                }
                                createRange() {
                                    return this.focus(),
                                        this.setLastRange(),
                                ...
                                setLastRange(t) {
                                    t ? this.lastRange = t : (this.lastRange = bt.create(this.editable),
                                    0 === n()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = bt.createFromBodyElement(this.editable)))
                                }
                                getLastRange() {
                                ...
                                getSelectedText() {
                                    ...
                                    return t.isOnAnchor() && (t = bt.createFromNode(ut.ancestor(t.sc, ut.isAnchor))),
                                        t.toString()
                                }
                                onFormatBlock(t, e) {
                                ...
                                fontStyling(t, e) {
                                    ...
                                    if ("" !== o) {
                                        ...
                                        if (this.$editor.find(".note-status-output").html(""),
                                            ...
                                            o.isCollapsed()) {
                                            const t = y.head(i);
                                            t && !ut.nodeLength(t) && (t.innerHTML = ut.ZERO_WIDTH_NBSP_CHAR,
                                        ...
                                        const t = n.a.now();
                                        this.$editor.find(".note-status-output").html('<div id="note-status-output-' + t + '" class="alert alert-info">' + this.lang.output.noSelection + "</div>"),
                                            setTimeout((function() {
                                ...
                                pasteByEvent(t) {
                                    ...
                                    if (e && e.items && e.items.length) {
                                        ...
                                        "file" === o.kind && -1 !== o.type.indexOf("image/") ? (this.context.invoke("editor.insertImagesOrCallback", [o.getAsFile()]),
                                            t.preventDefault(),
                                            this.context.invoke("editor.afterCommand")) : "string" === o.kind && (this.context.invoke("editor.isLimited", e.getData("Text").length) ? t.preventDefault() : this.context.invoke("editor.afterCommand"))
                                    }
                                }
                            }
                            ,
                            dropzone: class {
                                constructor(t) {
                                    this.context = t,
                                        ...
                                        this.$dropzone = n()(['<div class="note-dropzone">', '<div class="note-dropzone-message"/>', "</div>"].join("")).prependTo(this.$editor)
                                }
                                initialize() {
                                ...
                                attachDragAndDropEvent() {
                                    ...
                                    this.documentEventHandlers.onDragenter = o=>{
                                        ...
                                        i || t.length || !n || (this.$editor.addClass("dragover"),
                                        ...
                                        this.documentEventHandlers.onDragleave = e=>{
                                            t = t.not(e.target),
                                            t.length && "BODY" !== e.target.nodeName || (t = n()(),
                                        ...
                                        this.$dropzone.on("drop", t=>{
                                                ...
                                                t.preventDefault(),
                                                    e && e.files && e.files.length ? (this.$editable.focus(),
                                                        this.context.invoke("editor.insertImagesOrCallback", e.files)) : n.a.each(e.types, (t,o)=>{
                            ...
                            codeview: class {
                                    ...
                                    if (this.options.codeviewFilter && (t = t.replace(this.options.codeviewFilterRegex, ""),
                                        ...
                                        t = t.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, (function(t) {
                                                if (/<.+src(?==?('|"|\s)?)[\s\S]+src(?=('|"|\s)?)[^>]*?>/i.test(t))
                                                    return "";
                                                for (const o of e)
                                                    if (new RegExp('src="(https?:)?//' + o.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + '/(.+)"').test(t))
                                                        return t;
                                                return ""
                                            }
                                        ))
                                ...
                                activate() {
                                    if (this.$codable.val(ut.html(this.$editable, this.options.prettifyHtml)),
                            ...
                            hintPopover: class {
                                ...
                                replace() {
                                    ...
                                    if (t.length) {
                                        ...
                                        "next" === this.options.hintSelect) {
                                            ...
                                            bt.createFromNodeAfter(e).select();
                                        this.lastWordRange = null,
                                            this.hide(),
                                ...
                                nodeFromItem(t) {
                                    ...
                                    return "string" == typeof i && (i = ut.createText(i)),
                                        i
                                }
                                createItemTemplates(t, e) {
                                    ...
                                    return e.map((e,i)=>{
                                            ...
                                            return s.append(o.template ? o.template(e) : e + ""),
                                                s.data({
                                                    index: t,
                                                    item: e
                                                }),
                                ...
                                handleKeydown(t) {
                                    this.$popover.is(":visible") && (t.keyCode === kt.code.ENTER ? (t.preventDefault(),
                                        this.replace()) : t.keyCode === kt.code.UP ? (t.preventDefault(),
                                        this.moveUp()) : t.keyCode === kt.code.DOWN && (t.preventDefault(),
                                        this.moveDown()))
                                }
                                searchKeyword(t, e, o) {
                                ...
                                createGroup(t, e) {
                                    ...
                                    return this.searchKeyword(t, e, e=>{
                                            (e = e || []).length && (o.html(this.createItemTemplates(t, e)),
                                                this.show())
                                        }
                                    ),
                                        o
                                ...
                                handleKeyup(t) {
                                    if (!y.contains([kt.code.ENTER, kt.code.UP, kt.code.DOWN], t.keyCode)) {
                                        ...
                                        if ("words" === this.options.hintMode) {
                                            if (t = o.getWordsRange(o),
                                                e = t.toString(),
                                                this.hints.forEach(i=>{
                                                        if (i.match.test(e))
                                                            return t = o.getWordsMatchRange(i.match),
                                                                !1
                                                    }
                                                ),
                                                !t)
                            ...
                            autoReplace: class {
                                constructor(t) {
                                    this.context = t,
                                        ...
                                        this.keys = [kt.code.ENTER, kt.code.SPACE, kt.code.PERIOD, kt.code.COMMA, kt.code.SEMICOLON, kt.code.SLASH],
                                ...
                                replace() {
                                    ...
                                    this.options.match(e, (function(e) {
                                            if (e) {
                                                let o = "";
                                                if ("string" == typeof e ? o = ut.createText(e) : e instanceof jQuery ? o = e[0] : e instanceof Node && (o = e),
                                                    !o)
                                                    return;
                            ...
                            buttons: class {
                                ...
                                isFontInstalled(t) {
                                    return this.fontInstalledMap.hasOwnProperty(t) || (this.fontInstalledMap[t] = f.isFontInstalled(t) || y.contains(this.options.fontNamesIgnoreCheck, t)),
                                    ...
                                    return this.ui.buttonGroup({
                                        ...
                                        children: [this.button({
                                            ...
                                            callback: t=>{
                                                ...
                                                o && (e.css("background-color", this.options.colorButton.backColor),
                                                    t.attr("data-backColor", this.options.colorButton.backColor)),
                                                    i ? (e.css("color", this.options.colorButton.foreColor),
                                                        t.attr("data-foreColor", this.options.colorButton.foreColor)) : e.css("color", "transparent")
                                            }
                                        }), this.button({
                                                ...
                                                t.find(".note-holder-custom").each((t,o)=>{
                                                    ...
                                                    t.find("input[type=color]").each((e,o)=>{
                                                            n()(o).change((function() {
                                                                    ...
                                                                    e.css("background-color", o).attr("aria-label", o).attr("data-value", o).attr("data-original-title", o),
                                                                        e.click()
                                                                }
                                                            ))
                                                        }
                                            ...
                                            click: e=>{
                                                ...
                                                if ("openPalette" === s) {
                                                    const t = o.find("#" + r)
                                                        ...
                                                        , s = t.val();
                                                    i.css("background-color", s).attr("aria-label", s).attr("data-value", s).attr("data-original-title", s),
                                                        e.prepend(i),
                                                        t.click()
                                ...
                                addToolbarButtons() {
                                    ...
                                    this.context.memo("button.bold", ()=>this.button({
                                        ...
                                        this.context.memo("button.italic", ()=>this.button({
                                        ...
                                        this.context.memo("button.underline", ()=>this.button({
                                        ...
                                        this.context.memo("button.clear", ()=>this.button({
                                        ...
                                        this.context.memo("button.strikethrough", ()=>this.button({
                                        ...
                                        this.context.memo("button.superscript", ()=>this.button({
                                        ...
                                        this.context.memo("button.subscript", ()=>this.button({
                                        ...
                                        this.context.memo("button.fontname", ()=>{
                                                ...
                                                return this.options.addDefaultFonts && n.a.each(t["font-family"].split(","), (t,e)=>{
                                                        e = e.trim().replace(/['"]+/g, ""),
                                                        this.isFontDeservedToAdd(e) && -1 === this.options.fontNames.indexOf(e) && this.options.fontNames.push(e)
                                                    }
                                                ),
                                        ...
                                        this.context.memo("button.fontsizeunit", ()=>this.ui.buttonGroup([this.button({
                                            className: "dropdown-toggle",
                                        ...
                                        this.context.memo("button.color", ()=>this.colorPalette("note-color-all", this.lang.color.recent, !0, !0)),
                                        this.context.memo("button.forecolor", ()=>this.colorPalette("note-color-fore", this.lang.color.foreground, !1, !0)),
                                        this.context.memo("button.backcolor", ()=>this.colorPalette("note-color-back", this.lang.color.background, !0, !1)),
                                        this.context.memo("button.ul", ()=>this.button({
                                        ...
                                        this.context.memo("button.ol", ()=>this.button({
                                    ...
                                    this.context.memo("button.justifyLeft", b.invoke(t, "render")),
                                        ...
                                        this.context.memo("button.paragraph", ()=>this.ui.buttonGroup([this.button({
                                            className: "dropdown-toggle",
                                        ...
                                        this.context.memo("button.height", ()=>this.ui.buttonGroup([this.button({
                                            className: "dropdown-toggle",
                                        ...
                                        this.context.memo("button.table", ()=>this.ui.buttonGroup([this.button({
                                            className: "dropdown-toggle",
                                        ...
                                        this.context.memo("button.link", ()=>this.button({
                                        ...
                                        this.context.memo("button.picture", ()=>this.button({
                                        ...
                                        this.context.memo("button.video", ()=>this.button({
                                        ...
                                        this.context.memo("button.hr", ()=>this.button({
                                        ...
                                        this.context.memo("button.fullscreen", ()=>this.button({
                                        ...
                                        this.context.memo("button.codeview", ()=>this.button({
                                        ...
                                        this.context.memo("button.redo", ()=>this.button({
                                        ...
                                        this.context.memo("button.undo", ()=>this.button({
                                        ...
                                        this.context.memo("button.help", ()=>this.button({
                                ...
                                addImagePopoverButtons() {
                                    this.context.memo("button.resizeFull", ()=>this.button({
                                        ...
                                        this.context.memo("button.floatNone", ()=>this.button({
                                            contents: this.ui.icon(this.options.icons.rollback),
                                            tooltip: this.lang.image.floatNone,
                                            click: this.context.createInvokeHandler("editor.floatMe", "none")
                                        }).render()),
                                        this.context.memo("button.removeMedia", ()=>this.button({
                                ...
                                addLinkPopoverButtons() {
                                    this.context.memo("button.linkDialogShow", ()=>this.button({
                                        ...
                                        this.context.memo("button.unlink", ()=>this.button({
                                ...
                                addTablePopoverButtons() {
                                    this.context.memo("button.addRowUp", ()=>this.button({
                                        ...
                                        this.context.memo("button.addRowDown", ()=>this.button({
                                            className: "btn-md",
                                        ...
                                        this.context.memo("button.addColLeft", ()=>this.button({
                                            className: "btn-md",
                                        ...
                                        this.context.memo("button.addColRight", ()=>this.button({
                                            className: "btn-md",
                                        ...
                                        this.context.memo("button.deleteRow", ()=>this.button({
                                            className: "btn-md",
                                        ...
                                        this.context.memo("button.deleteCol", ()=>this.button({
                                            className: "btn-md",
                                            contents: this.ui.icon(this.options.icons.colRemove),
                                            tooltip: this.lang.table.delCol,
                                            click: this.context.createInvokeHandler("editor.deleteCol")
                                        }).render()),
                                        this.context.memo("button.deleteTable", ()=>this.button({
                                            className: "btn-md",
                                            contents: this.ui.icon(this.options.icons.trash),
                                ...
                                tableMoveHandler(t) {
                                    ...
                                    s.css({
                                        ...
                                        i.data("value", l + "x" + c),
                                    l > 3 && l < this.options.insertTableMaxSize.col && r.css({
                                        width: l + 1 + "em"
                                    }),
                            ...
                            toolbar: class {
                                ...
                                followScroll() {
                                    ...
                                    const r = this.$document.scrollTop()
                                        ...
                                        , l = a - s
                                        , c = a + t - s - o - i;
                                    !this.isFollowing && r > l && r < c - o ? (this.isFollowing = !0,
                                        this.$toolbar.css({
                                            position: "fixed",
                                            top: s,
                                            width: e,
                                        ...
                                        })) : this.isFollowing && (r < l || r > c) && (this.isFollowing = !1,
                                        this.$toolbar.css({
                                            position: "relative",
                                            top: 0,
                                            width: "100%",
                            ...
                            linkDialog: class {
                                ...
                                bindEnterKey(t, e) {
                                    t.on("keypress", t=>{
                                            t.keyCode === kt.code.ENTER && (t.preventDefault(),
                                                e.trigger("click"))
                                        }
                                    )
                                }
                            ...
                            imageDialog: class {
                                ...
                                show() {
                                    this.context.invoke("editor.saveRange"),
                                        this.showImageDialog().then(t=>{
                                                this.ui.hideDialog(this.$dialog),
                                                    this.context.invoke("editor.restoreRange"),
                                                    "string" == typeof t ? this.options.callbacks.onImageLinkInsert ? this.context.triggerEvent("image.link.insert", t) : this.context.invoke("editor.insertImage", t) : this.context.invoke("editor.insertImagesOrCallback", t)
                                            }
                                        ).fail(()=>{
                                                this.context.invoke("editor.restoreRange")
                                            }
                                ...
                                showImageDialog() {
                                    return n.a.Deferred(t=>{
                                            ...
                                            this.ui.onDialogShown(this.$dialog, ()=>{
                                                    this.context.triggerEvent("dialog.shown"),
                                                        e.replaceWith(e.clone().on("change", e=>{
                                ...
                                update(t, e) {
                                    if (ut.isImg(t)) {
                                        const o = n()(t).offset()
                                            , i = n()(this.options.container).offset();
                                        let s = {};
                                        this.options.popatmouse ? (s.left = e.pageX - 20,
                                            s.top = e.pageY) : s = o,
                                            s.top -= i.top,
                                            s.left -= i.left,
                                            this.$popover.css({
                            ...
                            videoDialog: class {
                                ...
                                createVideoNode(t) {
                                    ...
                                    if (o && 11 === o[1].length) {
                                        ...
                                        f = n()("<iframe>").attr("frameborder", 0).attr("src", "https://instagram.com/p/" + i[1] + "/embed/").attr("width", "612").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true");
                                    else if (s && s[0].length)
                                        f = n()("<iframe>").attr("frameborder", 0).attr("src", s[0] + "/embed/simple").attr("width", "600").attr("height", "600").attr("class", "vine-embed");
                                    else if (r && r[3].length)
                                        f = n()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("src", "//player.vimeo.com/video/" + r[3]).attr("width", "640").attr("height", "360");
                                    else if (a && a[2].length)
                                        f = n()("<iframe>").attr("frameborder", 0).attr("src", "//www.dailymotion.com/embed/video/" + a[2]).attr("width", "640").attr("height", "360");
                                    else if (l && l[1].length)
                                        f = n()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "498").attr("width", "510").attr("src", "//player.youku.com/embed/" + l[1]);
                                        ...
                                        f = n()("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");
                                    else {
                                        if (!m || !m[0].length)
                                            return !1;
                                    ...
                                    return f.addClass("note-video-clip"),
                                        f[0]
                                }
                                show() {
                                    const t = this.context.invoke("editor.getSelectedText");
                                    this.context.invoke("editor.saveRange"),
                                        this.showVideoDialog(t).then(t=>{
                                                this.ui.hideDialog(this.$dialog),
                                                    this.context.invoke("editor.restoreRange");
                    ...
                    return {
                        ...
                        palette: function(e, o) {
                            return s.a.create('<div class="note-color-palette"/>', (function(e, o) {
                                    ...
                                    e.html(i.join("")),
                                    o.tooltip && e.find(".note-color-btn").tooltip({
